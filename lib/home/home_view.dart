            ...
            GestureDetector(
              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    Image.asset(
                      'assets/icon/home_page_icon/location_icon.png',
                      height: 14,
                    ),
        ...
        child: Obx(
          () => CustomScrollView(
            slivers: [
              ...
              SliverToBoxAdapter(
                child: SectionHeader(
                  title: 'home_low_cost_intracity'.tr,
                  onViewAll: controller.onIntercityViewAll,
                ),
              ),
              SliverToBoxAdapter(
                child: SizedBox(
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (_, i) {
                      ...
                      return PromoInfoCard.intercity(
                        imageAsset:
                            p.imageAsset, // or 'assets/ambulance_written.png'
                        title: p.title,
                        subtitle: p.subtitle, // e.g. "30% discount"
                        bottomLeft: p
                            .dateText, // e.g. "02 Jul, 10:00 PM" (add this to model if needed)
              ...
              SliverToBoxAdapter(
                child: SectionHeader(title: 'home_last_ride_title'.tr),
              ),
              SliverToBoxAdapter(
                child: Column(
                  children: [
                    ...
                    DonationBanner(
                      ...
                      onPressed:
                          controller.onSupportNow, // << use controller method
                      ...
                      height: 150.h,
                      imageScale:
                          0.78, // tweak if you want a touch larger/smaller
                    ),
                    ...
                    DonationBanner(
                      ...
                      onPressed: controller
                          .onRequestSupport, // << use controller method
