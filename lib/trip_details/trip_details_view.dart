                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(color: neutral50),
                        child: Column(
                          children: [
                            DriverDetailsCard(
  ...
  Widget _infoCard() {
    return _card(
      child: Column(
        ...
        children: [
          Text(
            controller.formatToday(controller.tripTime.value),
        ...
        children: [
          Row(
            children: [
              ...
              const Spacer(),
              _badge(
                paid ? 'trip.badge.paid'.tr : 'trip.badge.unpaid'.tr,
                badgeColor,
              ),
            ],
          ),
          ...
          Row(
            children: [
              ...
              if (!controller.showCancelLink) ...[
                Expanded(
                  child: CustomButton(
                    btnTxt: 'report_issue'.tr,
                    btnColor: neutral50,
                    borderColor: neutral200,
                    txtColor: neutralBase,
                ...
                Expanded(
                  child: CustomButton(
                    btnTxt: 'rebook_trip'.tr,
                    onTap: controller.onRebook,
                  ),
                ),
              ],
            ],
