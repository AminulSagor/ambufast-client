  ...
  ({String label, Color bg, Color fg}) _pillForStatus() {
    switch (status) {
      case TripCardStatus.upcoming:
        return (
          label: 'tk_upcoming_badge'.tr.isNotEmpty
              ? 'tk_upcoming_badge'.tr
              : 'Upcoming',
...
class _PillBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Text(
        text,
        style: TextStyle(fontSize: 16.sp, color: fg),
      ),
    );
  }
}
