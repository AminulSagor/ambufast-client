...
class TripDetailsController extends GetxController {
  ...
  String formatToday(DateTime dt) {
    ...
    return isToday
        ? 'Today, ${DateFormat('h:mm a').format(dt)}'
  ...
  void onEditTrip() => Get.snackbar('Cancel', 'Trip Edit requested');
  void onTrackTrip() => Get.snackbar('Cancel', 'Trip Track requested');
  void onReportIssue() => Get.snackbar('Cancel', 'Trip Report requested');
